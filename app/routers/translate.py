...
@router.post("/tes/{union_key}/en", summary="Translate all TES of particular union fi→en")
...
@router.post("/tes/{union_key}/ru", summary="Translate all TES of particular union fi→ru")
