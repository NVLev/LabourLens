...
def upgrade() -> None:
    ...
    op.add_column('agreements', sa.Column('parsed_at', sa.TIMESTAMP(timezone=True), nullable=True))
    op.add_column('agreements', sa.Column('content_hash', sa.String(length=64), nullable=True))
