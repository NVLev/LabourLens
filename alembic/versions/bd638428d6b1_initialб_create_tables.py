...
def upgrade() -> None:
    ...
    op.create_index('ix_faq_rules_conditions', 'faq_rules', ['conditions'], unique=False, postgresql_using='gin')
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['matched_faq_id'], ['faq_rules.id'], ),
    sa.ForeignKeyConstraint(['topic_id'], ['topics.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('faq_section_refs',
    sa.Column('faq_id', sa.Integer(), nullable=False),
    sa.Column('section_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['faq_id'], ['faq_rules.id'], ),
    sa.ForeignKeyConstraint(['section_id'], ['sections.id'], ),
    sa.PrimaryKeyConstraint('faq_id', 'section_id')
    )
    op.create_table('section_paragraphs',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('section_id', sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index('ix_faq_rules_conditions', table_name='faq_rules', postgresql_using='gin')
