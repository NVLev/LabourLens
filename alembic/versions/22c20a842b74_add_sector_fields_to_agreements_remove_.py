...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column(
        "agreements", sa.Column("sector_fi", sa.String(length=200), nullable=True)
    )
    op.add_column(
        "agreements", sa.Column("sector_en", sa.String(length=200), nullable=True)
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "unions",
        sa.Column(
            "sector_en", sa.VARCHAR(length=200), autoincrement=False, nullable=True
        ),
    )
